...
UBrickGameInstance::UBrickGameInstance() {
    ...
    this->BrickStaticInfoClasses.AddDefaulted(431);
    this->BrickFilterClasses.AddDefaulted(20);
    this->BrickMaterials.AddDefaulted(18);
    ...
    this->InventoryItemClasses.AddDefaulted(40);
    this->UIStyleClasses.AddDefaulted(4);
    this->WeatherConditions.AddDefaulted(12);
    this->LevelInfos.AddDefaulted(13);
    this->GameModeInfos.AddDefaulted(6);
