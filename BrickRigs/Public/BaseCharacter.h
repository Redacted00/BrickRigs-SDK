...
class BRICKRIGS_API ABaseCharacter : public ACharacter, public IBrickPawnInterface, public IViewTargetInterface, public IGenericTeamAgentInterface, public IFireInterface, public IVehicleCollisionInterface {
    GENERATED_BODY()
public:
protected:
